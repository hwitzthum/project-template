...
STARTKIT='^(scripts/|\.claude/|docs/templates/|docs/profil/|CLAUDE\.md$|README\.md$|\.gitignore$|\.gitattributes$|docs/KURSANLEITUNG\.md$|KURSANLEITUNG\.docx$|docs/startkit-update)'
